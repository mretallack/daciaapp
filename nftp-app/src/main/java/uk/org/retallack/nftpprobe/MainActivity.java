package uk.org.retallack.nftpprobe;
...
import uk.org.retallack.nftp.HeadUnitExplorer;
import uk.org.retallack.nftp.HexDump;
import uk.org.retallack.nftp.NftpProbe;
...
public class MainActivity extends Activity {
    ...
    private static final String ACTION_USB_PERMISSION = "uk.org.retallack.nftpprobe.USB_PERMISSION";
    ...
    private void refreshExplorer() {
        ...
        if (explorer == null || !explorer.isConnected()) {
            runOnUiThread(() -> explorerView.<TextView>findViewById(R.id.txtPath).setText(currentPath));
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                explorerView.<TextView>findViewById(R.id.txtPath).setText(currentPath);
                explorerAdapter.updateEntries(finalEntries);
                if (fallback)
                    android.widget.Toast.makeText(this, "@ls failed, showing cached tree", android.widget.Toast.LENGTH_SHORT).show();
            });
        }).start();
    }
