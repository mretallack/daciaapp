...
public class NngDeserializerTest {
    ...
    public void testDecodeIdentifierString() {
        // TAG_ID_STRING uses null-terminated strings (matching real head unit behavior)
        byte[] data = {NngSerializer.TAG_ID_STRING, 'd', 'e', 'v', 'i', 'c', 'e', 0x00};
    ...
    public void testDecodeDictVli() {
        // Dict with 1 entry: key=IdString "name" (null-terminated), value=String "test"
        byte[] data = {
            NngSerializer.TAG_DICT_VLI_LEN, 0x01,
            NngSerializer.TAG_ID_STRING, 'n', 'a', 'm', 'e', 0x00,
